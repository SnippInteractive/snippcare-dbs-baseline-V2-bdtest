CREATE VIEW [dbo].[VW_VoucherDevice]
AS
SELECT     d.Id AS DeviceId, d.DeviceId AS DeviceDeviceId, d.Reference AS DeviceReference, d.HomeSiteId AS DeviceHomeSiteId,
                          (SELECT     Name
                            ...
                            WHERE      (DeviceStatusId = d.DeviceStatusId)) AS DeviceStatusName, d.UserId AS DeviceUserId, d.Owner AS DeviceOwner, d.ExpirationDate AS DeviceExpirationDate, 
                      d.StartDate AS DeviceStartDate,
                          (SELECT     Name
                          ...
                          (SELECT     Name
                            ...
                            WHERE      (Id = dpt.DeviceProfileExpirationTypeId)) AS DeviceProfileExpirationType,
                          (SELECT     Name
                            FROM          dbo.DeviceType AS dt
                            WHERE      (d.DeviceTypeId = DeviceTypeId)) AS DeviceTypeName, d.CreateDate, dp.Id AS DeviceProfileId, d.LotSequenceNo AS DeviceLotSequenceNo
FROM         dbo.Device AS d INNER JOIN
                      ...
                      dbo.DeviceProfileTemplateType AS dptt ON dptt.Id = dpt.DeviceProfileTemplateTypeId
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_VoucherDevice';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_VoucherDevice';
