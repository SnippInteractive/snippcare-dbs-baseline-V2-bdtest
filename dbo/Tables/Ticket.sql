CREATE TABLE [dbo].[Ticket] (
    ...
    [UserId]                 INT           NULL,
    [TicketIdentificationNo] VARCHAR (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    ...
    [CardNo]                 VARCHAR (30)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [ContactTime]            VARCHAR (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [CreatedBy]              INT           NULL,
    [AssignedTo]             INT           NULL,
    [ClientId]               INT           NULL,
