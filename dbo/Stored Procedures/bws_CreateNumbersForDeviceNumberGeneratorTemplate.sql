...
-- Description:	Creates a specified number of device numbers for a given device number generator template
--				1000 numbers approx 15 seconds
-- =============================================
CREATE PROCEDURE [dbo].[bws_CreateNumbersForDeviceNumberGeneratorTemplate]
