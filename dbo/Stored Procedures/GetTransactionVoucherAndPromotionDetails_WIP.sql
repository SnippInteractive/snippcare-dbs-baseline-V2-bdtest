...
CREATE Procedure [dbo].[GetTransactionVoucherAndPromotionDetails_WIP] 
(
	@ClientId	int,
	@TrxId		int
) 
...
BEGIN   
		...
		BEGIN
			...
			SELECT		td.ItemCode,
						td.Description as ItemName,
						tup.PromotionName COLLATE DATABASE_DEFAULT as 'Name',
						tup.PromotionName COLLATE DATABASE_DEFAULT as PromotionName,
						tup.PromotionDescription COLLATE DATABASE_DEFAULT as 'Description',
						tup.OfferValue  as VoucherAmount,
						tup.OfferValue  as PointBalance,
						tup.PromotionName COLLATE DATABASE_DEFAULT as DeviceId,
						td.TrxDetailId,
						td.Quantity ,
						null as PromotionId,
						td.BonusPoints 
